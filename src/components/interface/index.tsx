    ...
    <section id="interface" className="w-full">
      ...
      <div className="bg-white pt-20 pb-16 px-6 md:px-20">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          {/* Label */}
          <div className="flex items-center w-fit justify-center gap-2 mb-8 px-4 py-2 text-white text-sm font-medium bg-[linear-gradient(153deg,#1712FF_0%,#0142FE_83.33%)] shadow-[0_1px_4px_0_rgba(128,152,168,0.12)] rounded-[99px]">
            <span className="text-white text-sm font-medium">Interface</span>
          </div>

          {/* Title */}
          <h2 className="text-3xl md:text-5xl font-medium text-[#0D0D0D] mb-6">
